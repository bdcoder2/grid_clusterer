// Source: D:\vscode\grid_clusterer\v161\js\ex4\tester.js
class tester {
    /*
    ---------------------------------------------------------------------
    Constructor
    ...
    */
    advanced_cluster_marker_update_handler(evt) {
        ...
        if (evt.tile.marker instanceof google.maps.marker.AdvancedMarkerElement) {
    ...
    */
    advanced_grid_point_marker_click_handler(evt) {
        // Update the number of data points in the title ...
        if (evt.grid_point.marker instanceof google.maps.marker.AdvancedMarkerElement) {
            let s;
            s = '<b>Grid point</b><ul>';
