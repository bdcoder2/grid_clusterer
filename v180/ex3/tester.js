// Source: D:\vscode\grid_clusterer\v190\js\ex3\tester.js
/*
=====================================================================
...
class tester {
    ...
    */
    constructor(mvp_id) {
        ...
        */
        ...
        // Checkbox to show or hide data markers ...
        $('#cb_sdp').on('change', () => {
            let show_data = $('#cb_sdp').is(':checked');
            this.data_markers_visible(show_data);
        });
    ...
    */
    data_markers_create() {
        ...
        for (i = 0; i < this.data_points.length; i++) {
            ...
            marker = new google.maps.marker.AdvancedMarkerElement({ map: null, position: latlon, title: this.data_points[i].key.toString() });
    ...
    */
    data_markers_visible(is_visible) {
        let i;
        let marker;
        // Update checkbox to reflect if data points are visible ...
        $('#cb_sdp').prop('checked', is_visible);
        // Loop to show or hide data points ...
