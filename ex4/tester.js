// Source: D:\vscode\grid_clusterer\v160\js\ex4\tester.js
class tester {
    /*
    ---------------------------------------------------------------------
    Constructor
    ...
    */
    constructor(mvp_id, center_lat, center_lon) {
        ...
        map_opts = {
            ...
            zoom: 8,
            mapId: 'DEMO_MAP_ID' // Advanced Markers requires a map ID
        };
        try {
        ...
        */
        ...
        google.maps.event.addListener(this.map, 'grid_point_click', (evt) => {
            this.advanced_grid_point_marker_click_handler(evt);
        });
    }
    /*
    ---------------------------------------------------------------------
    ...
    */
    ...
    /*
    ---------------------------------------------------------------------
    Called when we need to create a cluster marker - this will create an
    "advanced marker"
    ---------------------------------------------------------------------
    */
    advanced_cluster_marker_create_handler(evt) {
        // Use the number of data points as the marker title ...
        let data_key_count = evt.tile.data_keys.length;
        ...
        cm_div.textContent = evt.tile.data_keys.length.toString();
        let marker_opts = {
            position: evt.tile.bounds.getCenter(),
            title: evt.tile.data_keys.length.toString(),
            content: cm_div
        };
        return new google.maps.marker.AdvancedMarkerView(marker_opts);
    }
    /*
    ---------------------------------------------------------------------
    Called when we need to update a cluster marker ...
    ---------------------------------------------------------------------
    */
    advanced_cluster_marker_update_handler(evt) {
        // Update the number of data points in the title ...
        if (evt.tile.marker instanceof google.maps.marker.AdvancedMarkerView) {
            evt.tile.marker.title = evt.tile.data_keys.length.toString();
        }
    }
    /*
    ---------------------------------------------------------------------
    Called when we need to create a grid point marker - this will create
    an "advanced marker"
    ---------------------------------------------------------------------
    */
    advanced_grid_point_marker_create_handler(evt) {
        // Use the number of data points as the marker title ...
        let cm_div = document.createElement('div');
    ...
    ---------------------------------------------------------------------
    */
    advanced_grid_point_marker_click_handler(evt) {
        // Update the number of data points in the title ...
        if (evt.grid_point.marker instanceof google.maps.marker.AdvancedMarkerView) {
            let s;
            s = '<b>Grid point</b><ul>';
    ...
    /*
    ---------------------------------------------------------------------
    Called when we need to update a grid pont marker ...
    ---------------------------------------------------------------------
    */
    advanced_grid_point_marker_update_handler(evt) {
        // Update the number of data points in the title ...
        if (evt.grid_point.marker instanceof google.maps.marker.AdvancedMarkerView) {
    ...
    */
    grid_clusterer_options_get() {
        ...
        grd_opts = {
            ...
            cluster_marker_create_handler: this.advanced_cluster_marker_create_handler,
            cluster_marker_update_handler: this.advanced_cluster_marker_update_handler,
            ...
            grid_point_marker_create_handler: this.advanced_grid_point_marker_create_handler,
            grid_point_marker_update_handler: this.advanced_grid_point_marker_update_handler,
